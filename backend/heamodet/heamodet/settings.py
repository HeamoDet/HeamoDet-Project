"""
Django settings for heamodet project.
...
SECRET_KEY = 'django-insecure-h$o(_=o%76+z48asfu_=01%lg4vd=t(ha*yv^k_7s7w8z&aaoo'
...
WSGI_APPLICATION = 'heamodet.wsgi.application'
